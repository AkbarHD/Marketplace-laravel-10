    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.product_orders.index')" :active="request()->routeIs('admin.product_orders_index')">
                        {{ __('My Orders') }}
                    </x-nav-link>
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <img src="{{ Storage::url(Auth::user()->avatar) }}" height="36" width="36"
                                alt="img-user">
                        </button>
